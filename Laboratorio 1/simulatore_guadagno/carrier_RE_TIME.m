function  dN=carrier_RE_time(t,N,opt,I,S_noise,S_sgn,dz_slice,L,htw,wSOA,matrix_L,isgn)
...
Ndens=N/(dz_slice*1e-4*wSOA*1e-4); % portatori in cm^-2
...
dN=(I/const_phys.e.data*1e16*dz_slice/L-Rsp-N/(material.tau_nr*1e-9)-Rst_sgn);
